...
public class Main
{
    public static void main(String[] args)
    {
        ...
        int finder = SafeInput.getRangedInt(in, "Enter an integer value between 1 and 100", 100, 1);
        occurrenceScan(dataPoints, finder);

        int finder2 = SafeInput.getRangedInt(in, "Enter an integer value between 1 and 100", 100, 1);
    ...
    public static double getAverage(int val[])
    {
        ...
        System.out.printf("\nThe average of the random array dataPoints is: %.2f \n", average);
        //Using print f to avoid long double print
        return average;
    }
    public static int sum(int val[])
    {
        ...
        System.out.println("The sum of the random array dataPoints is: " + totalSum);
        return totalSum;
    }
    ...
    public static int occurrenceScan(int val[], int num)
    {
        int count = 0;
    ...
    public static boolean contains(int val[], int num)
    {
        ...
        if (container != -1)
        {
            System.out.println("The value " + num + " was found at array index: " + container);
            return true;
        }
        else
        {
